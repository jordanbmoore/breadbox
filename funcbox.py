...
def download_at_max_res(video, channel_file_path, metadata):
    try:
        ydl_opts = {'outtmpl': channel_file_path + '/' + video['snippet']['title'], 'quiet' : True, 'simulate' : False}
        print('Downloading \"' + video['snippet']['title'] + '\"...')
        ...
        print("Successfully downloaded \"" + video['snippet']['title'] + '\"!')
    except:
        print("Failed to download \"" + video['snippet']['title'] + '\".')
